...
By selecting Android target 34, Unity is going to ask you to update (in the case you don't have the SDK 34 installed). Please, press "Update Android SDK" button.
