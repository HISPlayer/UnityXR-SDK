...
Please, download the sample here: [**OpenXRSample**](https://downloads.hisplayer.com/Unity/XR/HISPlayer_OpenXR_Sample_1.0.3.unitypackage) (no need to download it if you have received it in the email). 
